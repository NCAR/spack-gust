...
local mapT =
{
   grouped = {
      ...
      ['modules/[^/]+/cray%-mpich/[^/]+/intel%-oneapi%-compilers/[^/]*$'] = 'MPI-dependent Software - [intel-oneapi-compilers + cray-mpich]',
      ['modules/[^/]+/hpcx%-mpi/[^/]+/intel%-oneapi%-compilers/[^/]*$'] = 'MPI-dependent Software - [intel-oneapi-compilers + hpcx-mpi]',
      ['modules/[^/]+/intel%-mpi/[^/]+/intel%-oneapi%-compilers/[^/]*$'] = 'MPI-dependent Software - [intel-oneapi-compilers + intel-mpi]',
      ['modules/[^/]+/intel%-oneapi%-mpi/[^/]+/intel%-oneapi%-compilers/[^/]*$'] = 'MPI-dependent Software - [intel-oneapi-compilers + intel-oneapi-mpi]',
      ['modules/[^/]+/mpi%-serial/[^/]+/intel%-oneapi%-compilers/[^/]*$'] = 'MPI-dependent Software - [intel-oneapi-compilers + mpi-serial]',
      ['modules/[^/]+/mpich/[^/]+/intel%-oneapi%-compilers/[^/]*$'] = 'MPI-dependent Software - [intel-oneapi-compilers + mpich]',
      ['modules/[^/]+/mvapich2/[^/]+/intel%-oneapi%-compilers/[^/]*$'] = 'MPI-dependent Software - [intel-oneapi-compilers + mvapich2]',
      ['modules/[^/]+/mvapich2%-gdr/[^/]+/intel%-oneapi%-compilers/[^/]*$'] = 'MPI-dependent Software - [intel-oneapi-compilers + mvapich2-gdr]',
      ['modules/[^/]+/openmpi/[^/]+/intel%-oneapi%-compilers/[^/]*$'] = 'MPI-dependent Software - [intel-oneapi-compilers + openmpi]',
      ['modules/[^/]+/intel%-oneapi%-compilers/[^/]*$'] = 'Compiler-dependent Software - [intel-oneapi-compilers]',
