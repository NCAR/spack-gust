...
export LMOD_SYSTEM_DEFAULT_MODULES="ncarenv/22.08:craype/2.7.17:cce/14.0.2:ncarcompilers/0.5.2:cray-mpich/8.1.18:netcdf/4.8.1:cray-libsci/22.08.1.1"
export MODULEPATH=/glade/u/apps/gust/modules/environment

# Location of Lmod initialization scripts
LMOD_ROOT=/glade/u/apps/gust/22.08/spack/opt/spack/lmod/8.7.2/gcc/7.5.0/e5tuy5r
