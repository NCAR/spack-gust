...
export LMOD_SYSTEM_DEFAULT_MODULES="ncarenv/24.12:craype/2.7.33:intel/2024.2.1:ncarcompilers/1.0.0:cray-mpich/8.1.31:netcdf/4.9.2"
...
export LMOD_PACKAGE_PATH=/glade/u/apps/gust/24.12/envs/public/util
export LMOD_CONFIG_DIR=/glade/u/apps/gust/24.12/envs/public/util
export LMOD_AVAIL_STYLE=grouped:system

# Location of Lmod initialization scripts
export LMOD_ROOT=/glade/u/apps/gust/24.12/spack/opt/spack/lmod/8.7.37/gcc/12.4.0/daf4
...
export LMOD_MODULERCFILE=/glade/u/apps/gust/24.12/envs/public/util/hidden-modules
