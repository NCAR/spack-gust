...
export LMOD_SYSTEM_DEFAULT_MODULES="ncarenv/23.04:craype/2.7.20:intel/2023.0.0:ncarcompilers/0.8.0:cray-mpich/8.1.25:netcdf/4.9.1"
export MODULEPATH=/glade/u/apps/gust/modules/environment

# Location of Lmod initialization scripts
export LMOD_ROOT=/glade/u/apps/gust/23.04/spack/opt/spack/lmod/8.7.14/gcc/7.5.0
