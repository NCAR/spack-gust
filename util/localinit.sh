...
export LMOD_SYSTEM_DEFAULT_MODULES="ncarenv/25.07:craype/2.7.34:intel/2024.2.1:ncarcompilers/1.0.0:cray-mpich/8.1.32:netcdf/4.9.3"
...
export LMOD_PACKAGE_PATH=/glade/u/apps/gust/25.07/envs/public/util
export LMOD_CONFIG_DIR=/glade/u/apps/gust/25.07/envs/public/util
export LMOD_AVAIL_STYLE=grouped:system

# Location of Lmod initialization scripts
export LMOD_ROOT=/glade/u/apps/gust/25.07/spack/opt/spack/lmod/8.7.55/gcc/12.5.0/yczh
...
export LMOD_MODULERCFILE=/glade/u/apps/gust/25.07/envs/public/util/hidden-modules
